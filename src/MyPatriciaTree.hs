...
-- All the code in here is copied directly from
-- https://hackage.haskell.org/package/fgl-5.5.2.3/docs/src/Data-Graph-Inductive-PatriciaTree.html
-- with unused code removed, and the definition of mkGraph changed

module MyPatriciaTree
    ( Gr
    , UGr
    )
    where
